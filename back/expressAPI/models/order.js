...
exports.order_set = function (req, res) {
    ...
    con.query('insert into order2(stu_id,tea_id,order_address,order_time,class_time)  values(?,?,?,?,?)',
        [stu_id,tea_id, order_address, order_time,class_time], (err, result) => {
            if (err) {
...
exports.select_order_stu = function(req,res){
    var stu_id = req.query.stu_id;
     var select2 = 'select tea_name,tea_sex,stu_grade,stu_courses,tea_school,tea_major,tea_grade,'
                 +'order_id,class_time,order_time,order_address '
